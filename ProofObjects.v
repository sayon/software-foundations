...
Definition gorgeous_plus13_po: forall n, gorgeous n -> gorgeous (13+n):= 
  fun (n:nat) (H: gorgeous n) => g_plus5( 8 + n) ( g_plus5( 3 + n) (g_plus3 n H)).
(** [] *)
...
Theorem t: forall P Q R, P /\ Q -> Q /\ R -> P /\ R.
Proof.
  intros P Q R H H0.
...
(fun H1 : P /\ R => H1)
  ...
  | conj H1 H2 =>
      (fun (H3 : P) (_ : Q) =>
       (fun H5 : P /\ R => H5)
         match H0 with
         | conj H5 H6 => (fun (_ : Q) (H8 : R) => conj P R H3 H8) H5 H6
         end) H1 H2
  end.
...
Definition beautiful_iff_gorgeous : forall n, beautiful n <-> gorgeous
  n := fun (n : nat) => conj (beautiful n -> gorgeous n) (gorgeous n -> beautiful n) (beautiful__gorgeous n) (gorgeous__beautiful n).
...
Proof.
  ...
  (*a very dumb way since two inversions on H and H0 prove it  *)
  assert (a = e).
  apply ( trans_eq nat a c e).
  inversion H.
  reflexivity.
  inversion H0.
  reflexivity.
