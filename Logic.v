...
Proof.
  ...
  unfold not in H0.
  unfold not. intro HP.
  apply H in HP.  apply H0 in H. inversion H.  apply H0 in HP. inversion HP. 
Qed.
...
Lemma ble_nat_n_Sm_false__ble_nat_n_m_false: forall n m,
