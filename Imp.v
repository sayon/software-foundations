...
Fixpoint optimize_0plus_b (b : bexp) : bexp :=
   ...
   | BNot v => BNot (optimize_0plus_b v)
...
Proof.
  intros b.
  induction b; simpl;  try ( repeat (rewrite optimize_0plus_sound); reflexivity).
...
Fixpoint optimize_mult_2_sum (e: aexp) : aexp :=
  match e with
  | AMult (ANum 2) r => APlus r r
  | AMult l (ANum 2) => APlus l l
  | o => o
  end.
...
Proof.
  ...
  unfold update.
  destruct x1, x2.
  destruct (eq_id_dec (Id n0) (Id n)); reflexivity.
Qed.
